...
fn print_welcome() {
    ...
    println!("  Scan your drives or a specific folder for projects");
    println!("    devatlas scan");
    println!("    devatlas scan --path D:\\Projects");
    println!();
    println!("  List and search discovered projects");
    println!("    devatlas list");
    println!("    devatlas list --search api");
    println!("    devatlas list --category Web --active-only");
    println!();
    println!("  Open a project in a selected editor");
    println!("    devatlas open --name <project>");
    println!("    devatlas open --path D:\\Projects\\my-app");
    println!();
    println!("  Run a project");
    println!("    devatlas run --name <project>");
    println!("    devatlas run --name <project> --install --open-browser");
    println!();
    println!("  Analyze code structure and tech stack");
    println!("    devatlas analyze --name <project>");
    println!("    devatlas analyze --name <project> --files --tech-stack");
    println!();
    println!("  Check dependencies");
    println!("    devatlas dependencies --name <project>");
    println!("    devatlas dependencies --name <project> --check-updates");
    println!();
    println!("  View project and git statistics");
    println!("    devatlas stats --range month");
    println!("    devatlas stats --project <project> --top 10");
    println!();
    println!("  Find likely unused code");
    println!("    devatlas unused-code --name <project>");
    println!();
    println!("  Inspect cache and environment status");
    println!("    devatlas status");
    println!("    devatlas clear-cache");
    println!();
    println!("  Onboarding helpers");
    println!("    devatlas onboarding status");
    println!("    devatlas onboarding tour");
}
